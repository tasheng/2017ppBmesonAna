...
//	InfileBs = "BsPPCorrYieldPT_4.root";
...
*/
	...
	TFile * finFONLL = new TFile("FONLLs/output-Bs.root");
	finFONLL->cd();
	TGraphAsymmErrors *BsFONLL = (TGraphAsymmErrors*) finFONLL->Get("Graph");
	BsFONLL->SetLineColor(kRed+2);
	BsFONLL->SetMarkerStyle(20);
	BsFONLL->SetMarkerSize(1);
	BsFONLL->SetMarkerColor(kRed+2);
	...
	cRatio->SaveAs("Plots/Bs/BsFONLLComp.png");
//	cRatio->SetLogy();
	...
	cRatio->SaveAs("Plots/Bs/BsFONLLCompLog.png");

	cRatio->SaveAs("Plots/Bs/BsFONLLCompLog.pdf");
	...
	leg4->SetFillStyle(0);
	leg4->SetLineWidth(3);
	leg4->AddEntry(BsPPCrossGraph,"2017 pp 5.02 TeV","PL");
	leg4->AddEntry(BsPPCrossGraph2D,"2017 pp 5.02 TeV (2D Map)","PL");	
	leg4->AddEntry(BsPPCrossGraph2015,"2015 pp 5.02 TeV","PL");
//	leg4->AddEntry(BsFONLL,"FONLL Calculations","PL");
	leg4->Draw("same");
	...
	cRatio2->SaveAs("Plots/Bs/Bs2015Comp.png");
//	cRatio->SetLogy();
	...
	cRatio2->SaveAs("Plots/Bs/Bs2015CompLog.png");

	cRatio2->SaveAs("Plots/Bs/Bs2015CompLog.pdf");
