...
*/
	...
	TFile * RawYield = new TFile("RawYields/yields_Bp_binned_pt2.root");
	RawYield->cd();
	...
	TFile * fin1DEff = new TFile("NewEff2DMaps/EffFineBDT2.root");
	fin1DEff->cd();
...
//	leg->AddEntry(CorrDiffHis,"2017 pp","pl");
	...
	lat->DrawLatex(0.50,0.60,"B^{+} |y| < 2.4");

	c->SaveAs("FinalPlots/IncluveBPlus.png");
