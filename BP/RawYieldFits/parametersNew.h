...
double ptBinsInc[nBinsInc+1] = {0,10};
...
double ptBins_full[nBins_full+1] = {0,100};
double hiBins_full[nBins_full+1] = {0,90.*2};
const int nBins_bp = 11;
double ptBins_bp[nBins_bp+1] = {0.0,1.0,2.0,3.0,5.0,7,10,15,20,30,50,100};
