...
void  MCEff4(int DoTnP, int Rescale, float Factor){
...
//	TString infile = "/data/szhaozho/2017ppSamples/UnSkimmed/OfficialMC/BsMC.root";
	...
	TString infile = "/data/szhaozho/NewOfficialMCMore/Bs/BsMCAllBDT.root";
...
//	TH1D * Eff1DGENHis = new TH1D("Eff1DGENHis","",NPtBins,PtBin);
	...
	//	if(DoTnP == 1) outfileName = "NewEff2DMaps/EffFineBDT.root";
		if(DoTnP == 1) outfileName = Form("NewEff2DMaps/EffFineBDT_%.0f.root",Factor);
