...
void PlotSystBs(){
	...
	HisEmptyPt->GetXaxis()->SetTitle("B_{s} p_{T} (GeV/c)");
	...
	c->SaveAs("PlotSyst/Bs/BsPtSyst.png");
	...
	TGraphAsymmErrors * EffSystCent = new TGraphAsymmErrors(NCentBins,CentBin,CentBinY,CentBinWidthHigh,CentBinWidthLow,EffSystHighCent,EffSystLowCent);
	EffSystCent->SetLineWidth(2);
	EffSystCent->SetLineColor(4);
	EffSystCent->SetFillColor(0);

	TGraphAsymmErrors * TnPSystCent = new TGraphAsymmErrors(NCentBins,CentBin,CentBinY,CentBinWidthHigh,CentBinWidthLow,TnPSystHighCent,TnPSystLowCent);
	...
	cCent->SaveAs("PlotSyst/Bs/BsCentSyst.png");
	...
	cInc->SaveAs("PlotSyst/Bs/BsIncSyst.png");
	...
	lineInc->Draw("SAME");
	legInc->Draw("SAME");
	cComb->SaveAs("PlotSyst/Bs/SysSumPlot.png");
	cComb->SaveAs("PlotSyst/Bs/SysSumPlot.pdf");
